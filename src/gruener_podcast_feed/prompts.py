...
- Starte mit einem kurzen Intro mit Titel, Datum und Kontext. Lass Pia unbedingt erwähnen, dass es sich um einen KI-generierten Podcast handelt. Außerdem soll Nico erwähnen, dass der Podcast über die neuesten Informationen aus dem Newsletter der Grünen in Hamburg handelt.
